    ...
    axios
      ...
      .catch((error) => {
        ...
        toast({
          title: "Error.",
          description:
            "Error Adding task. please check your internet connection and try again",
          status: "error",
          duration: 900,
          isClosable: true,
        });
    ...
    >
      ...
      <Flex mt={8}>
        <button
          ...
          className="flex-1 bg-white hover:bg-dark-200 text-dark-500 hover:text-dark font-600 py-2 px-4 border border-grey-500 rounded-lg"
        >
          Cancel
        </button>
